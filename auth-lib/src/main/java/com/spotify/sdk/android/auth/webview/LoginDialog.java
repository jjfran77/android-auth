    ...
    private void createWebView(Uri uri) {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                String description_login_restriction_1 = mContextActivity.getString(R.string.description_login_restriction_1);
                String description_login_restriction_2 = mContextActivity.getString(R.string.description_login_restriction_2);
                String description2 = mContextActivity.getString(R.string.description2);


                String id1 = "login-to-continue";
                String id2 = "reset-password-link";
                String id3 = "sign-up-section";

                webView.loadUrl("javascript:" +
                        "var div = document.getElementById(\"" + id1 + "\");" +
                        "div.innerHTML = \"" + description2 + "\";" +
                        "div.style.fontSize = \"22px\";" +
                        "var p = document.createElement(\"p\");" +
                        "div.appendChild(p);" +
                        "var spaceBR1 = document.createElement(\"br\");" +
                        "document.getElementById(\"" + id2 + "\").appendChild(spaceBR1);" +
                        "document.getElementById(\"" + id2 + "\").appendChild(spaceBR1);" +
                        "document.getElementById(\"" + id2 + "\").appendChild(spaceBR1);" +
                        "void(0);");
                ...
                // Delete login with facebook, google and apple !!
                webView.loadUrl("javascript:document.getElementsByClassName(\"ng-scope\")[6].style.display = \"none\";void(0);");


                // Delete link to recovery password!
                webView.loadUrl("javascript: " +
                        "var div = document.getElementById(\"" + id2 + "\").innerHTML = \"\";void(0);");
                webView.loadUrl("javascript: " +
                        "var spaceBR1 = document.createElement(\"br\");" +
                        "document.getElementById(\"" + id2 + "\").innerHTML = \"\";void(0);");

                // Delete options create accound !!
                webView.loadUrl("javascript:document.getElementById(\"sign-up-section\")..appendChild(spaceBR1);void(0);");

                // Add message only user/password login
                webView.loadUrl("javascript: " +
                        "var div = document.getElementById(\"" + id3 + "\").innerHTML = \"\";" +

                        "var p1 = document.createElement(\"p\");" +
                        "p1.style.fontSize = \"13px\";" +
                        "p1.style.color = \"#666666\";" +
                        "p1.innerHTML = \"" + description_login_restriction_1 + "\";" +

                        "var p2 = document.createElement(\"p\");" +
                        "p2.style.fontSize = \"13px\";" +
                        "p2.style.color = \"#666666\";" +
                        "p2.innerHTML = \"" + description_login_restriction_2 + "\";" +

                        "var spaceBR1 = document.createElement(\"br\");" +
                        "var spaceBR2 = document.createElement(\"br\");" +
                        "document.getElementById(\"" + id3 + "\").appendChild(spaceBR1);" +
                        "document.getElementById(\"" + id3 + "\").appendChild(spaceBR2);" +
                        "document.getElementById(\"" + id3 + "\").appendChild(p1);" +
                        "document.getElementById(\"" + id3 + "\").appendChild(p2);" +
                        "document.getElementById(\"" + id3 + "\").appendChild(spaceBR2);" +
                        "document.getElementById(\"" + id3 + "\").appendChild(spaceBR2);" +
                        "void(0);");
